...
$config['ResourceType'][] = array(
        ...
        'maxSize' => 0,
        'allowedExtensions' => 'bmp,csv,doc,docx,gif,gz,gzip,jpeg,jpg,mov,mp3,mp4,mpc,mpeg,mpg,pdf,png,ppt,pptx,rar,swf,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
        'deniedExtensions' => '');
...
$config['ResourceType'][] = array(
        ...
        'maxSize' => 0,
        'allowedExtensions' => 'bmp,jpeg,JPEG,JPG,jpg,png,png,csv,doc,docx,pdf,xls,xlsx,txt,ppt,pptx',
        'deniedExtensions' => '');
