<x-admin-layout>
    ...
    <x-slot name="content">
        <x-admin.container-card>
            ...
            <form method="POST" action="{{ route('manage.admins.create') }}" id="quickForm">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="fk_designation_id" id="fk_designation_id" class="form-control">
                                    ...
                                    @if (old('fk_designation_id') && old('role_id'))
                                        @foreach ($designations as $designation)
                                            @if (in_array($designation->fk_role_id, old('role_id')))
                                                <option value="{{ $designation->id }}"
                                                    {{ old('fk_designation_id') == $designation->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ old('fk_office_onboarding_id') ? '' : 'd-none' }}">
                                    ...
                                    @if ($office_onboardings)
                                        @foreach ($office_onboardings as $office_onboarding)
                                            <option value="{{ $office_onboarding->id }}"
                                                {{ old('fk_office_onboarding_id') == $office_onboarding->id ? 'selected' : '' }}>
