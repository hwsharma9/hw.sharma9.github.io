<x-admin-layout>
    ...
    <x-slot name="content">
        <x-admin.container-card>
            <x-slot name="title">
                {{ __('ADD Office Onboarding') }}
            </x-slot>

            <form method="POST" action="{{ route('manage.officeonboardings.create') }}" id="quickForm">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                                    ...
                                    @if ($departments)
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}"
                                                {{ old('fk_department_id') == $department->id ? 'selected' : '' }}>
                                ...
                                <select name="fk_office_id" id="fk_office_id" class="form-control"
                                    ...
                                    @if (old('fk_office_id'))
                                        @foreach ($offices as $office)
                                            @if ($office->fk_department_id == old('fk_department_id'))
                                                <option value="{{ $office->id }}"
                                                    {{ old('fk_office_id') == $office->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nodal_name" class="form-control" id="nodal_name"
                                            placeholder="Enter Nodal Name" value="{{ old('nodal_name') }}"
                                            style="width: 100%;" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nodal_email" class="form-control" id="nodal_email"
                                            placeholder="Enter Nodal Email" value="{{ old('nodal_email') }}"
                                            style="width: 100%;" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nodal_contact_number" class="form-control"
                                            ...
                                            value="{{ old('nodal_contact_number') }}" style="width: 100%;" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="office_address" class="form-control"
                                            ...
                                            value="{{ old('office_address') }}" style="width: 100%;" />
                ...
                <div class="card-footer">
                    <x-admin.form-actions :actions="[
                        'create' => true,
                        'create_back' => route('manage.officeonboardings.create'),
                        'clear' => true,
        ...
        <script type="text/javascript">
            jQuery(function() {
                ...
                $("#fk_department_id").on("change", function() {
                    ...
                    // $('#fk_department_id').removeClass('error').addClass('valid');
                });
