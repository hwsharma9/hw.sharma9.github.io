                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <div class="float-sm-right">
                            @if (Gate::allows('check-auth', 'manage.admin_courses.create'))
                                <a href="{{ route('manage.admin_courses.create') }}" class="btn btn-primary"><i
        ...
        <script type="text/javascript">
            $(function() {
                var table = $('#dataTable').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: "{{ route('manage.admin_courses.index') }}",
                        data: function(d) {
                            const search_data = {}
                    ...
                    columns: [{
                        ...
                        {
                            data: row => row.admin.name + ' (' + row.admin.username + ')',
