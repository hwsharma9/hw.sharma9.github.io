        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="hidden" name="{{ 'topic[' . $parent_loop['index'] . '][id]' }}"
                        id="{{ 'topic_' . $parent_loop['index'] . '_id' }}" data-name="id" value="{{ $topic->id }}">
                    <input type="text" data-name="title" name="{{ 'topic[' . $parent_loop['index'] . '][title]' }}"
                        id="{{ 'topic_' . $parent_loop['index'] . '_title' }}"
                        data-validations="{{ json_encode(['required' => true, 'messages' => ['required' => 'Topic Title is Required.']]) }}"
                        value="{{ old('topic[' . $parent_loop['index'] . '][title]', $topic->update_title ? $topic->update_title : $topic->title) }}"
            ...
            @if (!$configuration)
                <div class="col-md-6">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="{{ 'topic[' . $parent_loop['index'] . '][course_video_id]' }}"
                                id="{{ 'topic_' . $parent_loop['index'] . '_course_id' }}"
                                value="{{ $course_video?->id }}" data-name="course_video_id">
                            <input type="text" data-name="course_video" class="form-control"
                                name="{{ 'topic[' . $parent_loop['index'] . '][course_video]' }}"
                                id="{{ 'topic_' . $parent_loop['index'] . '_course_video' }}"
                ...
                @if ($configuration->is_upload_video)
                    <div class="col-md-6">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input type="hidden"
                                    name="{{ 'topic[' . $parent_loop['index'] . '][course_video_id]' }}"
                                    id="{{ 'topic_' . $parent_loop['index'] . '_course_video_id' }}"
                                    value="{{ $course_video?->id ?? '' }}" data-name="course_video_id">
                                <input type="text" data-name="course_video"
                                    name="{{ 'topic[' . $parent_loop['index'] . '][course_video]' }}"
                                    id="{{ 'topic_' . $parent_loop['index'] . '_course_video' }}" class="form-control"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea type="text" data-name="summary"
                        ...
                        placeholder="Enter Topic Summary" name="{{ 'topic[' . $parent_loop['index'] . '][summary]' }}"
                        id="{{ 'topic_' . $parent_loop['index'] . '_summary' }}">{{ old('topic[' . $parent_loop['index'] . '][summary]', $topic->update_summary ? $topic->update_summary : $topic->summary) }}</textarea>
                </div>
            </div>
            @if (!$configuration)
                <div class="col-md-6">
                    <div class="col-md-12 upload-file">
                                    ...
                                    <div class="media-container mp-1">
                                        <div class="upload-row flex-wrap">
                                            <input type="file" data-name="course_pdf" class="course_pdf"
                                                name="{{ 'topic[' . $parent_loop['index'] . '][course_pdf][]' }}"
                                                id="{{ 'topic_' . $parent_loop['index'] . '_course_pdf' }}"
                                                ...
                                                accept="application/pdf" data-id="{{ encrypt($course_pdf->id) }}" />
                        ...
                        <button class="btn btn-primary btn-block mt-2 mb-2 add-file" type="button"
                            {{ count($course_pdfs) == 2 ? 'disabled' : '' }}><i class="fas fa-plus"></i></button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12 upload-file">
                                    ...
                                    <div class="media-container mp-1">
                                        <div class="upload-row flex-wrap">
                                            <input type="file" data-name="course_ppt" class="course_ppt"
                                                name="{{ 'topic[' . $parent_loop['index'] . '][course_ppt][]' }}"
                                                id="{{ 'topic_' . $parent_loop['index'] . '_course_ppt' }}"
                        ...
                        <button class="btn btn-primary btn-block mt-2 mb-2 add-file" type="button"
                            {{ count($course_ppts) == 2 ? 'disabled' : '' }}><i class="fas fa-plus"></i></button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12 upload-file">
                                    ...
                                    <div class="media-container mp-1">
                                        <div class="upload-row flex-wrap">
                                            <input type="file" data-name="course_doc" class="course_doc"
                                                name="{{ 'topic[' . $parent_loop['index'] . '][course_doc][]' }}"
                                                id="{{ 'topic_' . $parent_loop['index'] . '_course_doc' }}"
                        ...
                        <button class="btn btn-primary btn-block mt-2 mb-2 add-file" type="button"
                            {{ count($course_docs) == 2 ? 'disabled' : '' }}><i class="fas fa-plus"></i></button>
                    </div>
                </div>
            @else
