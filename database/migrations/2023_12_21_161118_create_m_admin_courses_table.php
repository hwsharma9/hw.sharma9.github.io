...
class CreateMAdminCoursesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_admin_courses', function (Blueprint $table) {
            $table->unsignedInteger('id', true);
            $table->unsignedInteger('fk_admin_id')->index();
    ...
    {
        Schema::dropIfExists('m_admin_courses');
    }
}
